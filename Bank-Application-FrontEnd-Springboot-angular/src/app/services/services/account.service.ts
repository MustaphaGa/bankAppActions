...
import { delete3 } from '../fn/account/delete-3';
import { Delete3$Params } from '../fn/account/delete-3';
...
export class AccountService extends BaseService {
  ...
  static readonly FindAll4Path = '/account/';
  ...
  static readonly Save4Path = '/account/';
  ...
  static readonly FindById4Path = '/account/{account-id}';
  ...
  static readonly Delete3Path = '/account/{account-id}';
   ...
   * This method doesn't expect any request body.
   */
  delete3$Response(params: Delete3$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
   ...
   * This method doesn't expect any request body.
   */
  delete3(params: Delete3$Params, context?: HttpContext): Observable<number> {
